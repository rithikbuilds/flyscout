...
SOURCES = [
  ...
  # ── GLOBAL / MULTI-MARKET TRACKERS ────────────────────────────────
    ...
    # Updated April 2026, covers October 2025 + April 2026 changes in detail
    ...
    # MCC — Mastercard interchange rates (updated with Oct 2025 changes)
    ...
    # Covers CNP refund authorization rule (Oct 2025), interregional rate hike
    {"id":"cb911_mc",    "market":"US","network":"Mastercard", "category":"interchange","cnp":True,
     "name":"Mastercard Interchange Fees 2026 — Chargebacks911",
     "url":"https://chargebacks911.com/mastercard-interchange-fees/"},

    # Clearly Payments — multi-market future of interchange (UK, EU, AU, CA, SG)
    # Source used for several verified seed entries, updates when major changes occur
    {"id":"clearly_global","market":"UK","network":"Both",     "category":"interchange","cnp":True,
     "name":"Future of Interchange Fees 2026 — Clearly Payments",
     "url":"https://www.clearlypayments.com/blog/the-future-of-interchange-fees-2026-and-beyond/"},

    # PYMNTS — interchange fee news archive, covers all markets
    # Updated April 2026 with Visa/Mastercard settlement developments
    ...
    # Payments Cards & Mobile — interchange fee category, covers UK and EU
    # Covers UK PSR cross-border fee reviews and EU IFR developments
    ...
    # ValPay — surcharging guidelines 2026, covers all markets including AU ban
    # Updated April 22 2026, covers US state rules, AU Oct 2026 ban, UK/EU
    ...
    # CMSPI — regulatory analysis, strong on UK PSR and EU cross-border
    # Covers PSR proposed cap on UK-EEA CNP interchange fees
    ...
    # Stax Payments — Visa interchange 2026 explainer, CNP focused
    # Updated May 2026, covers October 2025 Visa updates in detail
